...
config.contact = {};
config.contact.user = 'rejestracja@vikmp.pl';
config.contact.password = 'Vikkontakt123123';
config.contact.smtphost= 'labudamichve.nazwa.pl';
config.contact.email = 'VI Kongres Mediewistów Polskich ✔ <rejestracja@vikmp.pl>';
